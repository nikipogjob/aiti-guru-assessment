        ...
        <div className={styles.productsList}>
            <ul className={styles.productsList__list}>
                <li className={`${styles.productsList__listItem} ${styles['productsList__listItem--head']}`}>
                    ...
                    <div className={styles.productsList__cell}><span className={styles.productsList__headLabel}>Оценка</span></div>
                    <div className={styles.productsList__cell}><span className={styles.productsList__headLabel}>Цена, ₽</span></div>
                    <div className={styles.productsList__cell} />
                </li>
                {items.map((product) => (
